...
public class WekaClassification{ 
	...
	private static void evaluateAndAddMeasure(Evaluation e, Measure measure) {
	...
	public void walkForward(ExperimentParams params, List<Instances> sets, List<Measure> measures) throws Exception {
	    ...
	    if (evaluation == null) {
	        ...
	        Measure measure = createMeasureObject(filteredTrainingAndTestSet[0], filteredTrainingAndTestSet[1], labels,  i - 1);
	...
	public static void createFile(String path) throws Exception {
	    ...
	    List<Measure> measures = computeMeasures(paramsList, sets);
	    toCSV(measures);
	...
	public static List<Measure> computeMeasures(List<ExperimentParams> paramsList, List<Instances> sets) throws Exception {
